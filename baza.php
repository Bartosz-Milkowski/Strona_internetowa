...
<?php
    if($strona >= 1)
    {
      echo '<a href="http://mb41449.cba.pl/panel.php?subpage=baza&strona=1"> <-  </a>  ';  
    }
    else
    echo ("  <-");  
    ...
    for( $i; $i <= $wszystko; $i++)
    {
    echo '<a href="http://mb41449.cba.pl/panel.php?subpage=baza&strona='.$i.'">'.$i.'</a>  ';
    }
    
    if($strona < ($wszystko-1))
    {
      echo '<a href="http://mb41449.cba.pl/panel.php?subpage=baza&strona='.$wszystko.'"> -> </a>  ';  
    }
    else
    echo '->';  
}
